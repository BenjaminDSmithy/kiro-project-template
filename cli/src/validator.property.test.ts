...
const REQUIRED_SUBDIRS = ["kiro", "codex", "agents", "docs", "root"] as const;
...
describe("validateTemplateDir — Property Tests", () => {
   ...
   *
   * For any templates directory missing one or more of kiro/, codex/, agents/, docs/, root/,
  ...
  it(
    ...
    () => {
      fc.assert(
        fc.property(
          fc.subarray([...REQUIRED_SUBDIRS], { minLength: 0, maxLength: 4 }),
          (presentDirs) => {
